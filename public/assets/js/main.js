...
function HOMEINIT($){
	...
	var windowOn = $(window);
////////////////////////////////////////////////////
// 01. PreLoader Js (compatible con Angular)
const hideLoader = () => $("#loading").fadeOut(500);

if (document.readyState === 'complete') {
  // si Angular ya terminó de cargar cuando se inyecta el script
  hideLoader();
} else {
  // si aún no termina, escucha el evento load
  $(window).on('load', hideLoader);
  // respaldo por si el load no se dispara
...
// Exponer HOMEINIT para que Angular pueda invocarlo
